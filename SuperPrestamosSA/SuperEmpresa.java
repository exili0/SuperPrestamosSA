...
public class SuperEmpresa extends LogIn{
	
	private Paises paisSede;

	public void loginSuperEmpresa(String nickname, String contrasenya) {
		...
		listaSuperEmpresas.put(nickname, contrasenya); // Añadimos al TreeMap
	}
}
